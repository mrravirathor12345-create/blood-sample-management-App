...
const STATUS_STYLES = {
  scheduled: { color: '#5b8dff', bg: 'rgba(91,141,255,0.14)', label: 'Scheduled' },
  confirmed: { color: '#22d77a', bg: 'rgba(34,215,122,0.14)', label: 'Confirmed' },
  cancelled: { color: '#ff4d6d', bg: 'rgba(255,77,109,0.14)', label: 'Cancelled' },
};
      ...
      <div className="apt-header page-shell">
        ...
        <div className="apt-header-actions">
          <div className="apt-today-count glass-card">
            <span className="material-icons" style={{ color: '#ff7aaa' }}>today</span>
            <div>
