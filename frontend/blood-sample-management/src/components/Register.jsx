      ...
      >
        ...
        <form className="register-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="reg-form-row">
            ...
            <Field label="Last Name"  name="lastName"  placeholder="Doe"  icon="person_outline" />
          </div>

          {/* Username & Employee ID */}
          <div className="reg-form-row">
            <Field label="Username" name="username" placeholder="jdoe_lab" icon="badge" />
            <Field label="Employee ID" name="employeeId" placeholder="EMP-0001" icon="tag" />
          </div>

          {/* Email */}
          <Field label="Email Address" name="email" type="email" placeholder="john@lab.com" icon="alternate_email" />
