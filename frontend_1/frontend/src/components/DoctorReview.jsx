          ...
          {selectedReport ? (
            <div className="report-review">
              ...
              {selectedReport.aiAnalysis && (
                <div className="ai-insights-report-card glass-card apple-shadow">
                  <div className="ai-insights-header">
                    <span className="material-icons">psychology</span>
                    <h4>AI Clinical Verification</h4>
                    <span className={`ai-risk-tag ${selectedReport.aiAnalysis.riskLevel?.toLowerCase() || 'low'}`}>
                  ...
                  <div className="ai-insights-body">
                    {selectedReport.aiAnalysis.recommendations && selectedReport.aiAnalysis.recommendations.length > 0 ? (
                      <ul>
                        {selectedReport.aiAnalysis.recommendations.map((rec, i) => (
                          <li key={i}>
                      ...
                      <p>All metrics reside inside normal reference limits. Periodic screening recommended.</p>
                    )}
                  </div>
                </div>
              )}
